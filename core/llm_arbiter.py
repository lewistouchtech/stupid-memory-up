...
from configs.omlx_config import get_omlx_config, create_omlx_client
...
class LLMArbiter:
    ...
    def __init__(self, use_local: bool = True, arbiter_model: Optional[str] = None):
        """
        初始化仲裁器
    ...
    def _init_client(self):
        ...
        if self.use_local:
            ...
            self.client = create_omlx_client(config)
            self.model_name = self.arbiter_model or config.default_model
        else:
